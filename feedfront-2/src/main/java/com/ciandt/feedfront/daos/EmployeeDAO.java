...
public class EmployeeDAO implements DAO<Employee> {
    ...
    public List<Employee> listar() throws IOException, EntidadeNaoSerializavelException {
        ...
        List<String> files = getFiles(paths);
    ...
    private static List<String> getFiles(Stream<Path> paths) {
    ...
    public Employee atualizar(Employee employee) throws IOException, EntidadeNaoSerializavelException {
